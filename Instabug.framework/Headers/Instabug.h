...
/**
 @brief Sets an array of categories to be shown before bug reporting and feedback sender.
 
 @discussion When category is selected it will be sent as a tag in bug reporting or feedback.

 @param titles array of titles to be shown in the list.
 @param icon names array of icons to be shown in the list.
 */
+ (void)setCategoriesWithTitles:(NSArray<NSString *> *)titles iconNames:(nullable NSArray<NSString *> *)names;
